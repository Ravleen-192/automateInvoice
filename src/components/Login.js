...
class Login extends Component {
    ...
    handleSignIn = event => {
        ...
        Auth.signIn({ username, password })
            ...
            .then(() => {
                this.props.switchComponent("InvoiceProcessing");
            ...
            <section>
                    <div className="personalbg">
                        <div className="centerdiv">
                            <div>
                                <div><h3>We provide customized services and solutions designed to bring about a rapid transformation to your business.</h3></div>
                                <fieldset>
                                ...
                                <div className="new-line">
                                   <p> Not enrolled/forgot password?<a href="http://compnova.com/" target="_blank" rel="noopener noreferrer">Contact us</a> </p>
                                </div>
                            </div>
                        </div>
                    </div>
